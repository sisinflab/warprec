...
Content-based models generate recommendations by analyzing item attributes and comparing them with user preferences.
...
.. list-table::
   ...
   * -
     - AttributeItemKNN
     - Item-based KNN using content features.
   * -
     - UserKNN
   ...
   * - Unpersonalized
     - Pop
     - Recommends popular items to all users. Baseline model.
   * -
     - Random
     - Recommends items at random. Defines a performance lower bound.
