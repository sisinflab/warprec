...
!!! info "API Reference"
    ...
    For class signatures, parameters, and source code, see the [Content-Based API Reference](../api-reference/recommenders/content.md).

## Summary of Available Content Models

| Category | Model | Description |
|---|---|---|
| Vector Space | [VSM](#vsm) | Classical content-based model using TF-IDF and cosine similarity. |
...
For further details, please refer to the [paper](https://dl.acm.org/doi/10.1145/2362499.2362501).
